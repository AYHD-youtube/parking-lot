...
class ParkingLot:
    ...
    def leave(self, slot_to_be_freed):
        ...
        if found:
            ...
            print("""Slot number {} vacated, the car with vehicle registration number "{}" left the space, the driver of the car was of age {}""".
                format(slot_to_be_freed, car_to_leave.registration_number, car_to_leave.age))
            return True
    ...
    def park(self, car):
        ...
        print("""Car with registration number "{}" has been parked at slot number {}""".format(car.registration_number, slot_no))
    ...
    # Registration numbers of all drivers of a particular age
    def registration_numbers_for_drivers_with_age(self, age):
        registration_numbers = self.age_registration_mapping[age]
        print(",".join(registration_numbers))
        return self.age_registration_mapping[age]

    # Slot numbers of all slots where a drivers of a particular age is parked
